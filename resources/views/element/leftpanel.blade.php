       ...
       <!--  <li class="header">MAIN NAVIGATION</li> -->
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            @if($user_view_composer->hasRole('admin/connectivityservices',Auth::guard('admin')->user()->id))<li class="{{ Request::segment(2) === 'connectivityservices' ? 'active' : null }}" ><a href="{!!URL::to('/admin/connectivityservices')!!}"><i class="fa fa-circle-o"></i>Connectivity service master</a></li>@endif
        ...
        <li class="treeview">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            @if($user_view_composer->hasRole('admin/permission',Auth::guard('admin')->user()->id))<li class="{{ Request::segment(2) === 'permission' ? 'active' : null }}" ><a href="{{ url('/admin/permission')}}"><i class="fa fa-universal-access"></i>Manage permission</a></li>@endif
          </ul>
        </li>
