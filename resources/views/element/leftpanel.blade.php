       ...
       <!--  <li class="header">MAIN NAVIGATION</li> -->
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            @if($user_view_composer->hasRole('admin/connectivityservices',Auth::guard('admin')->user()->id))<li class="{{ Request::segment(2) === 'connectivityservices' ? 'active' : null }}" ><a href="{!!URL::to('/admin/connectivityservices')!!}"><i class="fa fa-circle-o"></i>Connectivity services master</a></li>@endif
            @if($user_view_composer->hasRole('admin/degree',Auth::guard('admin')->user()->id))<li class="{{ Request::segment(2) === 'degree' ? 'active' : null }}" ><a href="{!!URL::to('/admin/degree')!!}"><i class="fa fa-graduation-cap"></i>Degree master</a></li>@endif
            ...
            @if($user_view_composer->hasRole('admin/accrediation',Auth::guard('admin')->user()->id))<li class="{{ Request::segment(2) === 'accrediation' ? 'active' : null }}" ><a href="{!!URL::to('/admin/accrediation')!!}"><i class="fa fa-copyright"></i>Accrediation management</a></li>@endif            
            ...
            @if($user_view_composer->hasRole('admin/banner',Auth::guard('admin')->user()->id))<li class="{{ Request::segment(2) === 'banner' ? 'active' : null }}" ><a href="{!!URL::to('/admin/banner')!!}"><i class="fa fa-picture-o"></i>Banner management</a></li>@endif
        ...
        <li class="treeview">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            @if($user_view_composer->hasRole('admin/adminuser',Auth::guard('admin')->user()->id))<li class="{{ Request::segment(2) === 'adminuser' ? 'active' : null }}" ><a href="{{ url('/admin/adminuser')}}"><i class="fa fa-user-plus"></i>Manage user</a></li>@endif
