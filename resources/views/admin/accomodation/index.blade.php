      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="topbtn"><a href="{!!URL::to('/admin/accomodation/create')!!}"><button type="button" class="btn bg-purple btn-rightad" data-toggle="tooltip" data-original-title="Add"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;  ADD</button></a></div>
                    ...
                    @foreach($accomodation_lists as $accomodation_lists)
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="{!!URL::to('/admin/accomodation/edit',$accomodation_lists->id)!!}" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil-square-o" style="color:green;" aria-hidden="true"></i></a>&nbsp;                          
                          <a href="javascript:void(0)" onclick="return deldata('{!!URL::to('/admin/accomodation/delete',$accomodation_lists->id)!!}')" data-toggle="tooltip" data-original-title="Delete" ><i class="fa fa-times" style="color:red;" aria-hidden="true"></i></a>
                        </td>
