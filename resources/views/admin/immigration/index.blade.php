      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div><a href="{!!URL::to('/admin/immigration/create')!!}"><button type="button" class="btn bg-purple btn-rightad" data-toggle="tooltip" data-original-title="Add"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;ADD</button></a></div>
                          ...
                          <!-- delete the nerd (uses the destroy method DESTROY /nerds/{id} -->
                            <!-- we will add this later since its a little more complicated than the other two buttons -->
                             <!-- {!! Form::open(array('method' => 'DELETE','url' => array('admin/immigration/delete', $immigration_lists->id),'class' => 'pull-right')) !!}
                              ...
                              {!! Form::close() !!} -->
                          <a href="{!!URL::to('/admin/immigration/edit',$immigration_lists->id)!!}" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil-square-o" style="color:green;" aria-hidden="true"></i></a>&nbsp;
                          <a href="javascript:void(0)" onclick="return deldata('{!!URL::to('/admin/immigration/delete',$immigration_lists->id)!!}')" data-toggle="tooltip" data-original-title="Delete" ><i class="fa fa-times" style="color:red;" aria-hidden="true"></i></a>
                        </td>
                      </tr>
                    @endforeach
                  @endif
