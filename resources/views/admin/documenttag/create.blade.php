        ...
        <div class="col-md-12">
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
                 ...
                 {!! Form::open(array('method' => 'POST','role'=>'form','url'=>'admin/documenttag/store','id'=>'documenttag_add')) !!}
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          {!! Form::text('tag_name','',array('class'=>'form-control','id'=>'tag_name','placeholder'=>'Enter Tag Name')) !!}
