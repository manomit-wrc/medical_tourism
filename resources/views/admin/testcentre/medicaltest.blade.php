        ...
        <div class="col-md-12">
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
              ...
              @endphp
                {!! Form::open(array('method' => 'POST','role'=>'form','url'=>'admin/testcentre/store_medicaltest/','id'=>'medicaltest_add')) !!}
                  <input id="testcentre_id" name="testcentre_id" type="hidden" value="{{Request::segment(4)}}">                
                  <div class="col-md-6">                 
                        ...
                        @foreach($val['testarr'] as $key1 => $val1)                              
                         <li>
                          <table width="100%">
                              <tr>
                                <td width="90%">
                                  <input name="medicaltestArr[]" {{ in_array($val1['id'], $medicaltest_array)? 'checked':'' }} class="checkboxcatproduct{{ $val['cat_id'] }}" id="{{ $val1['id'] }}" type="checkbox" value="{{ $val1['id'] }}">
                                    {{ $val1['testname'] }}
                                </td>                            
                  ...
                  <div class="modal-dialog" style="width: 800px;">
                    <div class="modal-content" >
                      ...
                      <div class="modal-footer">                        
                        ...
                        <button onclick="return submitcentremedicaltest();" class="btn btn-primary">Save</button>
                      </div>                      
                    </div>      
                  </div>
                </div>
