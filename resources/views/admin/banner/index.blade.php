      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="topbtn"><a href="{!!URL::to('/admin/banner/create')!!}"><button type="button" class="btn bg-purple btn-rightad" ata-toggle="tooltip" data-original-title="Add"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; ADD</button></a></div>
                    ...
                    @foreach($banner_lists as $banner_lists)
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="{!!URL::to('/admin/banner/edit',$banner_lists->id)!!}" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil-square-o" style="color:green;" aria-hidden="true"></i></a>&nbsp;                         
                          <a href="javascript:void(0)" onclick="return deldata('{!!URL::to('/admin/banner/delete',$banner_lists->id)!!}')" data-toggle="tooltip" data-original-title="Delete" ><i class="fa fa-times" style="color:red;" aria-hidden="true"></i></a>
                        </td>
