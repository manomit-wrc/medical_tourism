                    ...
                    <!-- text input -->
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group {{ $errors->has('user_name') ? 'has-error' : '' }}">
                            ...
                            <input type="text" name="user_name" id="user_name" class="form-control" value="{{ $user_data[0]->name }}"  >
                            <span class="text-danger">{{ $errors->first('user_name') }}</span>
                          </div>

                          <div class="form-group {{ $errors->has('user_email') ? 'has-error' : '' }}">
                            <label for="user_email">Email: <span style="color:red;">*</span></label>
                            <input type="text" name="user_email" id="user_email" class="form-control" value="{{ $user_data[0]->email }}"  >
