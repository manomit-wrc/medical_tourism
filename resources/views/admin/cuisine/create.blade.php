        ...
        <div class="col-md-12">
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
                 ...
                 {!! Form::open(array('method' => 'POST','role'=>'form','url'=>'admin/cuisine/store','id'=>'cuisine_add')) !!}
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          {!! Form::text('name','',array('class'=>'form-control','id'=>'name','placeholder'=>'Enter cuisine name')) !!}
