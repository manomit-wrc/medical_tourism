  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{!!URL::to('/admin/providertype')!!}">Provider type</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
                 ...
                 {!! Form::open(array('method' => 'POST','role'=>'form','url'=>'admin/providertype/store','id'=>'providertype_add')) !!}
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          {!! Form::text('name','',array('class'=>'form-control','id'=>'name','placeholder'=>'Enter provider type name')) !!}
