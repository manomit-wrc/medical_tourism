        ...
        <div class="col-md-12">
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
                 ...
                 {!! Form::open(array('method' => 'POST','role'=>'form','files' => true,'url'=>'admin/connectivity/store','id'=>'connectivity_add')) !!}
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          {!! Form::text('name','',array('class'=>'form-control','id'=>'name','placeholder'=>'Enter connectivity name')) !!}
                        </div>
                        <!-- /.text input -->
